...
def get_matches(team_key, event_key):
    ...
    team_matches = [match for match in all_matches if team_key in (match['alliances']['blue']['team_keys'] + match['alliances']['red']['team_keys'])]
    return team_matches
